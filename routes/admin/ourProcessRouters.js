...
router.get('/process', checkLogin, async function (req, res, next) {
  ...
  await MongoClient.connect(url, function (err, db) {
    ...
    dbo.collection('option').findOne(function (err, result) {
      if (err) { return };
      console.log(err);
      res.render('admin/home/oProcess_show', { title: "Our Process", opt: result, headermenu:headermenu_dynamic, settingmenu:setting_dynamic, pagedata: expertise, expertiseitem: expertiseitem, 'msg': session.message});
