$(document).ready(function () {
  ...
  setTimeout(function () {
    ...
    $(".get-started-slider").bxSlider({
      touchEnabled: false,
      nextText:
        '<img src="./assets/images/agency_slide_move_next.svg" alt="Arrow Next Icon"/>',
      prevText:
        '<img src="./assets/images/about_slide_move_previous.svg" alt="Arrow Prev Icon"/>',
      slideZIndex: 3,
    });
    ...
    $(".process-slider").bxSlider({
      ...
      controls: true,
      nextText:
        '<img src="./assets/images/process_slide_move_next.svg" alt="Arrow Next Icon"/>',
      prevText:
        '<img src="./assets/images/process_slide_move_previous.svg" alt="Arrow Prev Icon"/>',
      adaptiveHeight: true,
      ...
      onSlideBefore: function (elem) {
        ...
        for (var i = 0; i <= idx; i++) {
          jQuery(
            '.process-pager li a[data-slide-index="' + i + '"] span'
          ).addClass("dot-active");
        }
      },
    ...
    $(".digital-slider").bxSlider({
      ...
      pager: false,
      nextText:
        '<img src="./assets/images/about_slide_move_next.svg" alt="Arrow Next Icon"/>',
      prevText:
        '<img src="./assets/images/about_slide_move_previous.svg" alt="Arrow Prev Icon"/>',
      mode: "fade",
    });
    $(".testimonial-slider").bxSlider({
      touchEnabled: false,
      nextText:
        '<img src="./assets/images/tesimonials_move_next.svg" alt="Arrow Next Icon"/>',
      prevText:
        '<img src="./assets/images/tesimonials_move_previous.svg" alt="Arrow Prev Icon"/>',
      pager: false,
      mode: "fade",
    });
    // }, 2000);
    ...
    $(".read-more-btn").on({
      mouseover: function () {
        $(this)
          .parents(".best-features-block")
          .find(".best-feature-icon")
          .addClass("left-icon");
        $(this)
          .parents(".best-features-block")
          .find(".best-feature-icon")
      ...
      mouseleave: function () {
        $(this)
          .parents(".best-features-block")
          .find(".best-feature-icon")
          .removeClass("left-icon");
        $(this)
          .parents(".best-features-block")
          .find(".best-feature-icon")
          .removeClass("right-icon");
        $(this)
          .parents(".best-features-block")
          .find(".best-feature-icon img")
          .fadeIn("fast");
    ...
    $(".footer-contact-description a").on({
      mouseover: function () {
        $(this)
          .parents(".footer-contact")
          .find(".location-icon #Location #Path_165")
          .css({
        ...
        $(this)
          .parents(".footer-contact")
          .find(".location-icon #Location #Path_164")
          .css({ fill: "rgb(255,255,255)" });
        $(this)
          .parents(".footer-contact")
          .find(".call-icon #Call #Path_98")
          .css({ fill: "rgb(255,255,255)" });
        $(this)
          .parents(".footer-contact")
          .find(".call-icon #Call #Path_102	")
          .css({ fill: "rgb(255,255,255)" });
        $(this)
          .parents(".footer-contact")
          .find(".call-icon #Call #Path_103")
          .css({ fill: "rgb(255,255,255)" });
        $(this)
          .parents(".footer-contact")
          .find(".mail-icon #Path_775")
          .css({ fill: "rgb(255,255,255)" });
        $(this)
          .parents(".footer-contact")
          .find(".mail-icon #Path_775")
...
setTimeout(function () {
  ...
  $(window).scroll(function () {
    ...
    var section1 = Utils.isElementInView(
      document.getElementsByClassName("digital-section-wr"),
      false
    );
    var section2 = Utils.isElementInView(
      document.getElementsByClassName("creator-content-area"),
      false
    );
    var section3 = Utils.isElementInView(
      document.getElementsByClassName("best-features-area"),
      false
    );
    var section4 = Utils.isElementInView(
      document.getElementsByClassName("process-slider-area"),
      false
    );
    var section5 = Utils.isElementInView(
      document.getElementsByClassName("our-project-wr"),
      false
    );
    var section6 = Utils.isElementInView(
      document.getElementsByClassName("counter-area"),
      false
    );
    // 1
    if (section1) {
    ...
    // counter
    var counterArea = Utils.isElementInView(
      document.getElementsByClassName("counter-area"),
      false
    );
